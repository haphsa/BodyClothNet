...
saved_weights = torch.load('/content/drive/My Drive/garNet.pth', map_location='cpu')
...
#net.load_state_dict(torch.load('/content/drive/My Drive/garNet.pth',map_location='cpu'),True)
net=net.to(device)
net.eval()
